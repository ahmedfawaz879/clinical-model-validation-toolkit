...
[![Notebook](https://github.com/ahmedfawaz879/clinical-model-validation-toolkit/actions/workflows/notebook.yml/badge.svg)](https://github.com/ahmedfawaz879/clinical-model-validation-toolkit/actions/workflows/notebook.yml)
...
push, plus `ruff` and `mypy`. A second workflow
(`.github/workflows/notebook.yml`) executes
`clinical-model-validation-toolkit.ipynb` end-to-end and fails the build if any
cell errors — the same clone-and-run guarantee applied to the executable
specification the package was built from.
...
└── .github/workflows/                 # ci.yml (tests/lint/typecheck), notebook.yml (executes the .ipynb)
```
